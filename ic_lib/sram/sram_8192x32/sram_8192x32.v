...
//      Test Muxes                  Off
//
//      Creation Date:  2024-08-16 16:59:26Z
//      Version: 	2005Q4V1
//
...
`celldefine
  module sram_8192x32 (
   ...
   specify
      ...
      $setuphold(posedge CLKA &&& flagA, posedge AA[12], 1.000, 0.500, NOT_AA12);
      $setuphold(posedge CLKA &&& flagA, negedge AA[12], 1.000, 0.500, NOT_AA12);
      ...
      $setuphold(posedge CLKB &&& flagB, posedge AB[12], 1.000, 0.500, NOT_AB12);
      $setuphold(posedge CLKB &&& flagB, negedge AB[12], 1.000, 0.500, NOT_AB12);
